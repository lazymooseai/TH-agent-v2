...
def get_flights():
    ...
    try:
        ...
        # JOS TULEE VIRHE 401, NAPATAAN TARKKA SYY RÖNTGENIÄ VARTEN
        if response.status_code == 401:
            virhesyy = response.text
            return [{"flight": "Pääsy evätty", "origin": "API-avain hylättiin", "time": "-", "type": "-", "status": "Virhe 401", "debug_json": f"Finavian palvelimen vastaus hylkäykselle:\n{virhesyy}"}]
