...
st.markdown("""
    ...
    /* Kevyt sääanimaatio (pilvi liikkuu) */
    @keyframes float {
    ...
    .alert-title { font-size: 24px; font-weight: 600; margin-bottom: 10px; color: #ff9999; }
    .taksi-link { color: #5bc0de; text-decoration: none; font-size: 16px; display: inline-block; margin-top: 10px; font-weight: 500;}
    
    /* Välilehtien tyylit (jos haluaa korostaa enemmän) */
