...
“time”: *etsi_aika(solut),
“pax”: pax,
})
if not laivat:
kortit = soup.find_all(“div”, class*=re.compile(r”(ship|laiva|vessel|row|card|item)”, re.I))
...
if pax >= 400:
return f”\U0001f525 {pax} matkustajaa (~{autoa} autoa, ERINOMAINEN)”, “pax-good”
if pax >= 200:
...
status = f”\U0001f525 Odottaa massapurkua - {status}”
elif “delay” in status.lower() or “myohassa” in status.lower():
status = f”\U0001f534 {status}”
...
return f”<span class='badge-red'>\U0001f6a8 +{minuutit} min - VR-korvaus mahdollinen!</span>”
...
<div class='header-container'>
  ...
  <div style='text-align:right;'>
    ...
    <a href='https://hsl.fi/aikataulut-ja-reitit/hairiot' class='taksi-link' target='_blank' style='font-size:18px;'>🚇 HSL-hairiot &#x2192;</a>
  </div>
</div>
""", unsafe_allow_html=True)
...
f”<span style='color:#aaa;'>(lahto: {j[‘origin’]}{tahti})</span><br>”
f”  └ {viive_badge(j[‘delay’])}<br><br>”
)
if any(j[“delay”] >= 60 for j in junat):
juna_html += “<br><span class='badge-red'>🚨 Yli 60 min myohassa - tarkista VR-korvauskäytanto!</span><br>”
else:
juna_html += “Ei saapuvia kaukojunia lahiaikoina.”
...
port_html += “Ei dataa - sivu vaatii JavaScript-renderonnin.<br>”
st.markdown(f”””
<div class='taksi-card'>
{port_html}
...
st.markdown(”<div class='section-header'>✈️ LENTOKENTTA (Helsinki-Vantaa)</div>”, unsafe_allow_html=True)
...
lento_html += “<span style='color:#aaa;font-size:15px;'>Frankfurt arki-iltaisin = paras business-lento | Sahkoautoilla tolppaetuoikeus</span><br><br>”
for lento in lennot:
...
with tab1:
paikat = [
{“nimi”: “Helsingin Kaupunginteatteri (HKT)”, “kap”: “947 hlo”, “huomio”: “Erinomainen - jopa 50 autoa huonolla kelilla. Normi 20-30.”, “linkki”: “https://hkt.fi/kalenteri/”, “teksti”: “HKT Kalenteri”, “badge”: “badge-red”},
{“nimi”: “Kansallisooppera ja -baletti”, “kap”: “~1 700 hlo”, “huomio”: “Klassikot ja ooppera parhaita. Baletti noin puolet. 1-2 autoa/100 pax.”, “linkki”: “https://oopperabaletti.fi/ohjelmisto-ja-liput/”, “teksti”: “Ooppera Ohjelmisto”, “badge”: “badge-yellow”},
{“nimi”: “Kansallisteatteri”, “kap”: “~700 hlo”, “huomio”: “Aseman vieressa - asiakkaat usein junaan. Pienempi kyytimäärä.”, “linkki”: “https://kansallisteatteri.fi/esityskalenteri”, “teksti”: “Kansallisteatteri Kalenteri”, “badge”: “badge-blue”},
{“nimi”: “Musiikkitalo”, “kap”: “1 704 hlo”, “huomio”: “Päärautatieaseman vieressa - monet kävelijoita. Kyytipotentiaali pieni.”, “linkki”: “https://musiikkitalo.fi/tapahtumat/”, “teksti”: “Musiikkitalo Tapahtumat”, “badge”: “badge-blue”},
...
with tab2:
paikat = [
{“nimi”: “HIFK - Nordis (jääkiekko)”, “kap”: “~8 200 hlo”, “huomio”: “Tärkein seura. Poistuma ~2,5 h kiekon putoamisesta.”, “linkki”: “https://liiga.fi/fi/ohjelma?kausi=2025-2026&sarja=runkosarja&joukkue=hifk&kotiVieras=koti”, “teksti”: “HIFK Kotiottelut”, “badge”: “badge-red”},
{“nimi”: “Kiekko-Espoo - Metro Areena”, “kap”: “~13 000 hlo”, “huomio”: “Suurin areena. Hyvä potentiaali myos Espoosta Helsinkiin.”, “linkki”: “https://liiga.fi/fi/ohjelma?kausi=2025-2026&sarja=runkosarja&joukkue=k-espoo&kotiVieras=koti”, “teksti”: “Kiekko-Espoo Kotiottelut”, “badge”: “badge-yellow”},
{“nimi”: “Jokerit - Mestis / Nordis”, “kap”: “~7 000 hlo”, “huomio”: “Nordis + Kerava. Tarkista pelipaikka - vaihtelee.”, “linkki”: “https://jokerit.fi/ottelut”, “teksti”: “Jokerit Ottelut”, “badge”: “badge-yellow”},
{“nimi”: “Olympiastadion (jalkapallo)”, “kap”: “36 000 hlo”, “huomio”: “HJK kotiottelut, maaottelut. Suuri poistumapiikki.”, “linkki”: “https://olympiastadion.fi/tapahtumat”, “teksti”: “Olympiastadion Tapahtumat”, “badge”: “badge-red”},
...
{“nimi”: “Kalastajatorppa / Pyorea Sali”, “kap”: “~400 hlo”, “huomio”: “Munkkiniemi. Business-illalliset. Pitkät kyydit kantakaupunkiin.”, “linkki”: “https://kalastajatorppa.fi”, “teksti”: “Kalastajatorppa”, “badge”: “badge-yellow”},
...
with tab4:
paikat = [
{“nimi”: “Tavastia”, “kap”: “~900 hlo”, “huomio”: “Rock, metal, pop. 1-2 autoa/100 pax. Huono sää nostaa.”, “linkki”: “https://tavastiaklubi.fi/fi_FI/ohjelma”, “teksti”: “Tavastia Ohjelma”, “badge”: “badge-yellow”},
{“nimi”: “On the Rocks”, “kap”: “~600 hlo”, “huomio”: “Rock, metal. Tarkista täyttöaste ennen siirtymistä.”, “linkki”: “https://www.ontherocks.fi/ohjelma”, “teksti”: “On the Rocks Ohjelma”, “badge”: “badge-yellow”},
{“nimi”: “Malmitalo”, “kap”: “~500 hlo”, “huomio”: “Malmilla - kauempana. Iskelmä, kansanmusiikki. Hyvä päivävuoroille.”, “linkki”: “https://malmitalo.fi/tapahtumat”, “teksti”: “Malmitalo Tapahtumat”, “badge”: “badge-blue”},
{“nimi”: “Sellosali (Espoo)”, “kap”: “~500 hlo”, “huomio”: “Leppävaara. Klassinen, jazz. Pitkä kyyti kaupunkiin.”, “linkki”: “https://sellosali.fi/ohjelma/”, “teksti”: “Sellosali Ohjelma”, “badge”: “badge-blue”},
]
st.markdown(f”<div class='taksi-card'>{venue_html(paikat)}</div>”, unsafe_allow_html=True)
...
<div style='display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;font-size:17px;'>
  <div>
    ...
    <a href='https://hsl.fi/aikataulut-ja-reitit/hairiot' class='taksi-link' target='_blank' style='font-size:15px;'>HSL Hairiot &#x2192;</a><br>
  ...
  <div>
    ...
    <a href='https://www.ilmatieteenlaitos.fi/sade-ja-pilvialueet?area=etela-suomi' class='taksi-link' target='_blank' style='font-size:15px;'>Sadetutka Etela-Suomi &#x2192;</a><br>
    <a href='https://www.ilmatieteenlaitos.fi/paikallissaa/helsinki' class='taksi-link' target='_blank' style='font-size:15px;'>Helsinki Paikallissaa &#x2192;</a>
  </div>
  <div>
...
<div style='display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;font-size:17px;'>
  ...
  <div>
    ...
    <a href='https://www.vr.fi/asiakaspalvelu/korvaukset-ja-hyvitykset' class='taksi-link' target='_blank' style='font-size:15px;'>VR Myohastymiskorvaus &#x2192;</a><br>
    <span style='color:#aaa;font-size:14px;'>Oikeutus: &gt;60 min myohassa + taksilupa konduktooriltä</span>
  </div>
</div>
"""
st.markdown(f"<div class='taksi-card'>{linkit_html}</div>", unsafe_allow_html=True)
st.markdown("<div style='color:#555;font-size:14px;text-align:center;margin-top:20px;'>TH Taktinen Tutka - Paivittyy 60 s valein - Digitraffic (MIT) - Port of Helsinki - Averio - Finavia</div>", unsafe_allow_html=True)
