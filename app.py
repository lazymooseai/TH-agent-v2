...
def get_flights_live(): # Nimi vaihdettu välimuistin (cachen) tuhoamiseksi!
    url = "https://apigw.finavia.fi/flights/public/v0/flights"
    api_key = "838062ef175f47708d566bbf5a38a710" 
    
    # TAKTIIKKA: Ammutaan avain sisään usealla eri otsikolla, jotta Finavian Azure-portti varmasti reagoi
    headers = {
    ...
    # Pakotetaan avain myös URL-parametriksi varmuuden vuoksi
    params = {
        'subscription-key': api_key
    }
    ...
    try:
        ...
        if response.status_code == 401:
            ...
            return [{"flight": "Pääsy evätty", "origin": "Avainta ei löydetty", "time": "-", "type": "-", "status": "Virhe 401", "debug_json": f"Vastaus:\n{virhesyy}"}]
...
flights = get_flights_live() # Kutsutaan UUTTA funktiota
