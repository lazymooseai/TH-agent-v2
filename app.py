...
from zoneinfo import ZoneInfo # UUSI: Pakottaa Suomen aikavyöhykkeen
        ...
        for juna in data:
            ...
            for rivi in juna['timeTableRows']:
                if rivi['stationShortCode'] == koodi and rivi['type'] == 'ARRIVAL':
                    ...
                    if aika_raaka:
                        try:
                            # Muunnetaan Fintrafficin UTC-aika oikeaoppisesti Suomen aikaan (huomioi kesä/talviajan)
...
# MÄÄRITETÄÄN PÄÄKELLO SUOMEN AIKAAN
