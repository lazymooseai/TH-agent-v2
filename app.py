    ...
    try:
        ...
        for rivi in rivit:
            ...
            if len(solut) >= 5:
                ...
                # Varmistetaan, että kyseessä on oikea datarivi (aika sisältää kaksoispisteen)
                if ":" in aika and lento:
                    
                    # 1. Onko laajarunko? (Tarkistetaan löytyykö kohteen nimi listasta)
                    ...
                    # 2. Taktiset korostukset status-kenttään
        ...
        if lennot_lista:
            # 3. Suodatetaan pois jo laskeutuneet tai terminaalissa olevat lennot
